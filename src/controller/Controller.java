...
//			screenAdjustment();
			FinalPlayersWindow finalPlayers = new FinalPlayersWindow();
			JButton ready = new JButton("Let's Play!");
			ready.setActionCommand("ready");
			ready.addActionListener(this);
			finalPlayers.getLowerPanel().add(ready);
			
			
			blank = new JTextArea("1");
			...
			if(firstHero.getName().equals("Rexxar")) {
				...
				player1.addMouseListener(new MouseAdapter() {
					...
					public void mouseEntered(MouseEvent e) {
						player1.setIcon(new ImageIcon("Images/rexxarGIF.gif"));
						rexxarText.setText("Rexxar");
						rexxarText.setFont(new Font("AR BONNIE", Font.BOLD, 50));
						rexxarText.setOpaque(false);
						rexxarText.setForeground(Color.WHITE);
						rexxarText.setEditable(false);
						player1.add(rexxarText, BorderLayout.SOUTH);
					}
				...
				finalPlayers.getButtons().add(player1);
			} else if(firstHero.getName().equals("Jaina Proudmoore")) {
				
				ImageIcon jainaProudmoore = new ImageIcon("Images/jaina.jpg");
				player1.setIcon(jainaProudmoore);
				player1.setContentAreaFilled(false);
				player1.setBorderPainted(false);
				player1.setLayout(new BorderLayout());
				player1.setFocusable(false);
				player1.addMouseListener(new MouseAdapter() {
					...
					public void mouseEntered(MouseEvent e) {
						player1.setIcon(new ImageIcon("Images/mageGIF.gif"));
						jaina.setText("Jaina Proudmoore");
						jaina.setFont(new Font("AR BONNIE", Font.BOLD, 30));
						jaina.setOpaque(false);
						jaina.setForeground(Color.WHITE);
						jaina.setEditable(false);
						player1.add(jaina, BorderLayout.SOUTH);
					}
				...
				player1.addMouseListener(new MouseAdapter() {
					...
					public void mouseEntered(MouseEvent e) {
						player1.setIcon(new ImageIcon("Images/paladin GIF.gif"));
						paladinText.setText("Uther Lightbringer");
						paladinText.setFont(new Font("AR BONNIE", Font.BOLD, 35));
						paladinText.setOpaque(false);
						paladinText.setForeground(Color.WHITE);
						paladinText.setEditable(false);
						player1.add(paladinText, BorderLayout.SOUTH);
					}
				...
				player1.addMouseListener(new MouseAdapter() {
					...
					public void mouseEntered(MouseEvent e) {
						player1.setIcon(new ImageIcon("Images/priestGIF.gif"));
						priestText.setText("Anduin Wrynn");
						priestText.setFont(new Font("AR BONNIE", Font.BOLD, 35));
						priestText.setOpaque(false);
						priestText.setForeground(Color.WHITE);
						priestText.setEditable(false);
						player1.add(priestText, BorderLayout.SOUTH);
					}
				...
				player1.addMouseListener(new MouseAdapter() {
					...
					public void mouseEntered(MouseEvent e) {
						player1.setIcon(new ImageIcon("Images/warlockGIF.gif"));
						warlockText.setText("Gul'dan");
						warlockText.setFont(new Font("AR BONNIE", Font.BOLD, 35));
						warlockText.setOpaque(false);
						warlockText.setForeground(Color.WHITE);
						warlockText.setEditable(false);
						player1.add(warlockText, BorderLayout.SOUTH);
					}
			...
			ImageIcon vsImg = new ImageIcon("Images/vs.png");
			vs.setIcon(vsImg);
			vs.setOpaque(false);
			finalPlayers.getButtons().add(vs);
			
			
			JButton player2 = new JButton();
			if(secondHero.getName().equals("Rexxar")) {
				ImageIcon rexxar = new ImageIcon("Images/rexxarButton.jpg");
				player2.setIcon(rexxar);
				...
				player2.addMouseListener(new MouseAdapter() {
					...
					public void mouseEntered(MouseEvent e) {
						player2.setIcon(new ImageIcon("Images/rexxarGIF.gif"));
						rexxarText.setText("Rexxar");
						rexxarText.setFont(new Font("AR BONNIE", Font.BOLD, 50));
						rexxarText.setOpaque(false);
						rexxarText.setForeground(Color.WHITE);
						rexxarText.setEditable(false);
						player2.add(rexxarText, BorderLayout.SOUTH);
					}
				...
				finalPlayers.getButtons().add(player2);
			} else if(secondHero.getName().equals("Jaina Proudmoore")) {
				
				ImageIcon jainaProudmoore = new ImageIcon("Images/jaina.jpg");
				player2.setIcon(jainaProudmoore);
				player2.setContentAreaFilled(false);
				player2.setBorderPainted(false);
				player2.setLayout(new BorderLayout());
				player2.setFocusable(false);
				player2.addMouseListener(new MouseAdapter() {
					...
					public void mouseEntered(MouseEvent e) {
						player2.setIcon(new ImageIcon("Images/mageGIF.gif"));
						jaina.setText("Jaina Proudmoore");
						jaina.setFont(new Font("AR BONNIE", Font.BOLD, 30));
						jaina.setOpaque(false);
						jaina.setForeground(Color.WHITE);
						jaina.setEditable(false);
						player2.add(jaina, BorderLayout.SOUTH);
					}
				...
				player2.addMouseListener(new MouseAdapter() {
					...
					public void mouseEntered(MouseEvent e) {
						player2.setIcon(new ImageIcon("Images/paladin GIF.gif"));
						paladinText.setText("Uther Lightbringer");
						paladinText.setFont(new Font("AR BONNIE", Font.BOLD, 35));
						paladinText.setOpaque(false);
						paladinText.setForeground(Color.WHITE);
						paladinText.setEditable(false);
						player2.add(paladinText, BorderLayout.SOUTH);
					}
				...
				player2.addMouseListener(new MouseAdapter() {
					...
					public void mouseEntered(MouseEvent e) {
						player2.setIcon(new ImageIcon("Images/priestGIF.gif"));
						priestText.setText("Anduin Wrynn");
						priestText.setFont(new Font("AR BONNIE", Font.BOLD, 35));
						priestText.setOpaque(false);
						priestText.setForeground(Color.WHITE);
						priestText.setEditable(false);
						player2.add(priestText, BorderLayout.SOUTH);
					}
				...
				player2.addMouseListener(new MouseAdapter() {
					...
					public void mouseEntered(MouseEvent e) {
						player2.setIcon(new ImageIcon("Images/warlockGIF.gif"));
						warlockText.setText("Gul'dan");
						warlockText.setFont(new Font("AR BONNIE", Font.BOLD, 35));
						warlockText.setOpaque(false);
						warlockText.setForeground(Color.WHITE);
						warlockText.setEditable(false);
						player2.add(warlockText, BorderLayout.SOUTH);
					}
			...
			finalPlayers.revalidate();
			finalPlayers.repaint();
			currentScreen.add(finalPlayers.getJ());
			currentScreen.revalidate();
			currentScreen.repaint();

			// ---------Farah trial extra screen----------//

		}
		
		if (click.getActionCommand().equals("ready")) {
